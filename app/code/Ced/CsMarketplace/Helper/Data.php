...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function sendProductMailToAdmin(){
        $pending_products = $this->_objectManager->create('Ced\CsMarketplace\Model\VproductsFactory')
                            ->create()
                            ->getCollection()
                            ->addFieldToFilter('check_status',\Ced\CsMarketplace\Model\Vproducts::PENDING_STATUS)
                            ->count();
        $this->_objectManager->get('Ced\CsMarketplace\Helper\Mail')->sendProductEmailToAdmin($pending_products);
    }
