...
class Mail extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function sendAccountEmailToAdmin($vendor, $storeId = null)
    {
        ...
        $admin['name'] = $this->_objectManager->get('Ced\CsMarketplace\Helper\Data')->getStoreConfig('trans_email/ident_general/name', $storeId);
        $admin['email'] = $this->_objectManager->get('Ced\CsMarketplace\Helper\Data')->getStoreConfig('trans_email/ident_general/email', $storeId);
        $vendor_url = $this->_objectManager->get('\Magento\Backend\Model\UrlInterface')->getUrl('csmarketplace/vendor/index');
    ...
    public function sendSellerTransactionEmail($model){
        ...
        $vendor = $this->_objectManager->create('Ced\CsMarketplace\Model\Vendor')->load($model->getVendorId());
