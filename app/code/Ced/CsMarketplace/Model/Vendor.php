...
class Vendor extends \Ced\CsMarketplace\Model\AbstractModel
{
    ...
    { 
        try{
            ...
            if (!empty($request->getFiles()->toArray())) { 
                $uploadedFiles = $request->getFiles('vendor');
            ...
            /*if(!$this->getMassFlag()) {
                ...
                $this->_objectManager->get('Ced\CsMarketplace\Helper\Mail')->sendAccountEmailToAdmin($this);
            ...
            foreach($availableMethods as $method) {
                ...
                if (isset($method['value'])) {
                    ...
                    if($method['model_class']=='*'){
                        ...
                        $object = $this->_objectManager->get($model_class);
                    }
