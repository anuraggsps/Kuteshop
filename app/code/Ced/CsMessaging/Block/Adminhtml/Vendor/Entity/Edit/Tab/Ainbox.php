...
class Ainbox extends \Magento\Backend\Block\Widget\Container
{
     ...
     * @var string
     */
    protected $_template = 'vendor/ainbox.phtml';
    ...
    protected function _prepareLayout()
    {
        $this->setChild(
            'grid',
            $this->getLayout()->createBlock('Ced\CsMessaging\Block\Adminhtml\Vendor\Entity\Edit\Tab\Ainbox\Grid', 'ced.csmessaging.vendor.admin.inbox.grid')
        );
