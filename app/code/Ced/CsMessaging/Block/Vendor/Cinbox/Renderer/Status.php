...
namespace Ced\CsMessaging\Block\Vendor\Cinbox\Renderer;

/**
 * Class Status
 * @package Ced\CsMessaging\Block\Vendor\Cinbox\Renderer
 */
class Status extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $messageCollection->addFieldToFilter('thread_id',$threadId)
            ->addFieldToFilter('sender',['neq'=>\Ced\CsMessaging\Helper\Data::VENDOR_AS_SENDER])
