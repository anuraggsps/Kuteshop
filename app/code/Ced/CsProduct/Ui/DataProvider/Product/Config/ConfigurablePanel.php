...
class ConfigurablePanel extends AbstractModifier {
	...
	public function modifyMeta(array $meta) {
		...
		if(!in_array('configurable', $allowdProductSet) || $this->request->getParam('type')!='configurable')
			return $meta;
				...
				'record' => [ 
						...
						'children' => [ 
								'thumbnail_image_container' => $this->getColumn ( 'thumbnail_image', __ ( 'Image' ), [ 
										...
										'uploaderConfig' => [ 
												'url' => $this->urlBuilder->addSessionParam ()->getUrl ( 'csproduct/product_gallery/upload' ) 
										],
										'dataScope' => 'image' 
								], [ 
