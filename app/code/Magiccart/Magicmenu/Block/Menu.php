 ...
 * @@Modify Date: 2018-10-13 16:12:48
 * @@Function:
 */
...
class Menu extends \Magento\Catalog\Block\Navigation
{
    ...
    public function __construct(
        ...
        $___store = $this->escapeHtml($this->getRequest()->getParam('___store'));
        if($___store){
            $store = $this->storeRepository->getActiveStoreByCode($___store);
            $this->httpContext->setValue(Store::ENTITY, $___store, 'default');
