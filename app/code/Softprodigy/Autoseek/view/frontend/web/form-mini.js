define([
    ...
    $.widget('mage.quickSearch', {
        options: {
            ...
            template:
            '<div class="row">' +
                '<li onclick="setLocation(\'<%- data.url %>\');" class="c-search__product col-8-8" id="qs-option-<%- data.index %>" role="option">' +
                    '<a class="c-search__image col-2-8" href="<%- data.url %>" title="<%- data.name %>">' +
                        '<img src="<%- data.image %>" title="<%- data.name %>">' +
                    '</a>' +

                    '<div class="c-search__description col-6-8 last">' +
                       '<span class="c-search__title h4">' +
