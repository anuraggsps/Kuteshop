 ...
 * @author mannu
 */
class AssignPaymentToQuote extends \Softprodigy\Minimart\Controller\AbstractAction {
    ...
    public function execute() {
        try {
            ...
            $this->_objectManager->get('Magento\Checkout\Model\Session')->replaceQuote($quote);

            $result = $this->_objectManager->get('Magento\Checkout\Model\Type\Onepage')->setQuote($quote)->savePayment(array('method' => $params['pay_method']));
