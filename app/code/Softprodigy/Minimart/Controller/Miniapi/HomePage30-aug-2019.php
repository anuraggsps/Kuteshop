...
class HomePage extends \Softprodigy\Minimart\Controller\AbstractAction implements CsrfAwareActionInterface {
	...
	public function getProductCollection($catid,$param,$itemidsarray){
		...
		foreach( $collection as $item){
			...
			if ($categoryId==3) {
                $othercategoryproducts['banner_image']=$baseurl."/pub/media/magiccart/magicproduct/catalog//b/3/b3.jpg";
			}elseif ($categoryId==6) {
				$othercategoryproducts['banner_image']=$baseurl."/pub/media/magiccart/magicproduct/catalog//b/4/b4.jpg";
			}elseif ($categoryId==62) {
				$othercategoryproducts['banner_image']=$baseurl."/pub/media/magiccart/magicproduct/catalog//b/5/b5.jpg";
			}elseif ($categoryId==7) {
				$othercategoryproducts['banner_image']=$baseurl."/pub/media/magiccart/magicproduct/catalog//b/6/b6.jpg";
			}elseif ($categoryId==8) {
				$othercategoryproducts['banner_image']=$baseurl."/pub/media/magiccart/magicproduct/catalog//b/7/b7.jpg";
			}elseif ($categoryId==93) {
				$othercategoryproducts['banner_image']=$baseurl."/pub/media/magiccart/magicproduct/catalog//b/8/b8.jpg";
			}
