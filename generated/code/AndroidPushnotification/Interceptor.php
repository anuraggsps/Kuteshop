<?php
namespace AndroidPushnotification;

/**
 * Interceptor class for @see \AndroidPushnotification
 */
class Interceptor extends \AndroidPushnotification implements \Magento\Framework\Interception\InterceptorInterface
{
